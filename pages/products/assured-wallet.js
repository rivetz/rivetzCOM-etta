...
class Confirm extends React.Component {
  ...
  static async getInitialProps () {
    return { // Return obj
      namespacesRequired: ['wallet', 'common']
    }
  }

  render () {
    const { t } = this.props
    const currentURL = '/products/assured-wallet'
    return (
      <LayoutGeneric>
        ...
        <Head>
          ...
          <link rel='stylesheet' href='/static/css/assured-wallet.css' />
        ...
        <div className='uk-section-large page-section section-intro'>
          ...
          <div className='illustration uk-visible@l app' data-uk-scrollspy='cls: uk-animation-slide-right-medium; repeat: true'>
            <img src='/static/img/illustrations/wallet/hero.svg' className='ill-hero' />
          </div>
          <div className='illustration uk-visible@l key1'>
            <img src='/static/img/illustrations/wallet/intro-key.svg' className='ill-hero' />
          </div>
        </div>

        {/* Page Section: Instruction */}
        <div className='uk-section-large page-section section-intent'>
          <div className='illustration intent uk-visible@l' data-uk-scrollspy='cls: uk-animation-slide-left-medium; repeat: true'>
            <img src='/static/img/illustrations/confirm/intent.svg' className='ill-hero' />
          </div>
          <div className='uk-container-large uk-grid-collapse' data-uk-grid>
            <div className='uk-width-1-1@xs'>
              <div className='section-content'>
                <div className='section-head'>
                  <h1 data-uk-scrollspy='cls: uk-animation-slide-top-medium; repeat: true'>{t('instruction.header')}</h1>
                </div>
                <div className='section-details'>
                  <p>{t('instruction.details')}</p>
                </div>
              </div>
              {/** TODO: Show SVG as divs instead so we can translate individual pieces. */}
              <div className='illustration instruction uk-visible@l' data-uk-scrollspy='cls: uk-animation-slide-left-medium; repeat: true'>
                <img src='/static/img/illustrations/wallet/instruction.svg' className='ill-hero' />
              </div>
              <div className='section-buttons uk-text-center' data-uk-scrollspy='cls: uk-animation-slide-bottom; repeat: true'>
        ...
        <div className='uk-section-large page-section section-revenue'>
          <div className='uk-container-large uk-grid-collapse' data-uk-grid>
            <div className='illustration uk-visible@l' data-uk-scrollspy='cls: uk-animation-slide-left-medium; repeat: true'>
              <img src='/static/img/illustrations/wallet/revenue.svg' className='ill-hero' />
            </div>
            <div className='uk-width-1-1@xs uk-width-1-2@l'>
              <div className='section-content' data-uk-scrollspy='cls: uk-animation-slide-bottom-medium; repeat: true'>
                <div className='section-head'>
                  <h1>{t('revenue.header')}</h1>
                </div>
                <div className='section-details'>
                  <p>{t('revenue.details')}</p>
                  <p>{t('revenue.details2')}</p>
                  <p><a href='mailto:sales@rivetz.com'>{t('revenue.more')}</a></p>
                </div>
              </div>
            </div>
          </div>
...
export default withNamespaces(['wallet', 'common'])(Confirm)
