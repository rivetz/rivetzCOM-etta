...
class Confirm extends React.Component {
  ...
  static async getInitialProps () {
    return { // Return obj
      namespacesRequired: ['confirm', 'common']
    }
  }

  render () {
    const { t } = this.props
    const currentURL = '/products/confirm'
    return (
      <LayoutGeneric>
        ...
        <div className='uk-section-large page-section section-intro'>
          ...
          <div className='illustration uk-visible@l app' data-uk-scrollspy='cls: uk-animation-slide-right-medium; repeat: true'>
            <img src='/static/img/illustrations/confirm/phone.svg' className='ill-hero' />
          </div>
          <div className='illustration uk-visible@l key1'>
            <img src='/static/img/illustrations/confirm/hero-key.svg' className='ill-hero' />
          </div>
        </div>
            ...
            <div className='uk-width-1-1@xs'>
              <div className='section-content'>
                <div className='section-head'>
                  <h1 data-uk-scrollspy='cls: uk-animation-slide-top-medium; repeat: true'>{t('intent.header')}</h1>
                </div>
                <div className='section-details'>
                  <p>{t('intent.details')}</p>
                </div>
              </div>
        ...
        <div className='uk-section-large page-section section-form'>
          <div className='uk-container-large uk-grid-collapse' data-uk-grid>
            <div className='illustration form-key uk-visible@l' data-uk-scrollspy='cls: uk-animation-slide-left-medium; repeat: true'>
              <img src='/static/img/illustrations/confirm/form-key.svg' className='ill-hero' />
            </div>
            <div className='uk-width-1-1@xs'>
              <div className='section-content' data-uk-scrollspy='cls: uk-animation-slide-bottom-medium; repeat: true'>
...
export default withNamespaces(['confirm', 'common'])(Confirm)
