...
import authenticatorContent from '../../static/locales/en/authenticator.json'
...
class Home extends React.Component {
  ...
  static async getInitialProps () {
    return { // Return obj
      namespacesRequired: ['authenticator', 'common']
    }
  }
  ...
  // Increment slider,
  incrementSlider (e) {
    if (this.state.sliderIncrement > (authenticatorContent.simpler.videos.length - 2)) {
      this.setState({
        sliderIncrement: 0
      })
    } else {
    ...
    return (
      <LayoutGeneric>
        ...
        <Head>
          ...
          <meta name='twitter:image:src' content='/static/logo/authenticator/250px.png' />

          <link rel='stylesheet' href='/static/css/authenticator.css' />
        ...
        <div className='uk-section-large page-section section-intro'>
          <div className='uk-container uk-container-large uk-grid-collapse' data-uk-grid>
            <div className='uk-width-1-1@xs uk-width-3-5@l'>
              ...
              <div className='section-buttons'>
                <Link href='/download?ref=authenticator'>
                  <a>
                    {t('hero.download')}
                  </a>
                </Link>
                <CompatibilityButton extraClass={'off-color'} />
              </div>
            </div>
          </div>
          ...
          <div className='illustration uk-visible@l key1'>
            <img src='/static/img/illustrations/authenticator/herokey.svg' className='ill-hero' />
          </div>
        </div>

        {/* Page Section: Protect */}
        <div className='uk-section-large page-section section-protect'>
            ...
            <div className='uk-width-1-1@xs uk-width-1-2@l'>
              <div className='section-content' data-uk-scrollspy='cls: uk-animation-slide-bottom-medium; repeat: true'>
                <div className='section-head'>
                  <h1>{t('protect.header')}</h1>
                </div>
                <div className='section-details'>
                  <p>{t('protect.details')}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='uk-section-large page-section section-videos section-slider-cont'>
          ...
          <div className='uk-container-large uk-grid-collapse' data-uk-grid>
            <div className='uk-width-1-1@xs'>
              <div className='section-content'>
                <div className='section-head'>
                  <h1 data-uk-scrollspy='cls: uk-animation-slide-top-medium; repeat: true'>{t('simpler.header')}</h1>
                </div>
                <div className='section-details'>
                  <p>{t('simpler.details')}</p>
                </div>
              </div>
              <div className='section-slider'>
                <ul style={{ 'marginLeft': 'calc(' + (this.state.sliderIncrement * -1) + '* (320px))' }} data-uk-scrollspy='cls: uk-animation-slide-bottom-medium; repeat: true'>
                  {authenticatorContent.simpler.videos.map((item, index) => (
                    <li key={index} title={t(`simpler.videos.${index}.title`)}>
        ...
        <div className='uk-section-large page-section section-policies'>
          <div className='illustration uk-visible@l phone' data-uk-scrollspy='cls: uk-animation-slide-right-medium; repeat: true'>
        ...
        {/* Page Section: Backup */}
        <div className='uk-section-large page-section section-backup'>
          <div className='illustration keys uk-visible@l' data-uk-scrollspy='cls: uk-animation-slide-left-medium; repeat: true'>
            <img src='/static/img/illustrations/authenticator/backup-key.svg' className='ill-hero' />
          </div>
          <div className='uk-container-large uk-grid-collapse' data-uk-grid>
            <div className='uk-width-1-1@xs'>
              <div className='section-content'>
                <div className='section-head'>
                  <h1 data-uk-scrollspy='cls: uk-animation-slide-top-medium; repeat: true'>{t('backup.header')}</h1>
                </div>
                <div className='section-details'>
                  <p>{t('backup.details')}</p>
                </div>
              </div>
            </div>
            <div className='uk-width-1-1@xs videoCont'>
              <iframe src='https://www.youtube-nocookie.com/embed/F168mMxJeuU?autoplay=1&amp;loop=1&amp;showinfo=0&amp;rel=0&amp;modestbranding=1&amp;playsinline=1' width='1920' height='1080' frameborder='0' data-allowfullscreen data-uk-responsive data-uk-video='automute: true' />
            </div>
          </div>
        </div>

        {/* Page Section: Download */}
        <div className='uk-section-large page-section section-download'>
          <div className='uk-container-large uk-grid-collapse' data-uk-grid>
            <div className='illustration app uk-visible@l' data-uk-scrollspy='cls: uk-animation-slide-left-medium; repeat: true'>
              <img src='/static/img/illustrations/authenticator/phone.svg' className='ill-hero' />
            </div>
            <div className='illustration download uk-visible@l' data-uk-scrollspy='cls: uk-animation-slide-left-medium; repeat: true'>
              <img src='/static/img/illustrations/authenticator/download-key.svg' className='ill-hero' />
            </div>
            <div className='uk-width-1-1@xs uk-width-1-2@l'>
              <div className='section-content' data-uk-scrollspy='cls: uk-animation-slide-bottom-medium; repeat: true'>
                <div className='section-head'>
                  <h1>{t('download.header')}</h1>
                </div>
                <div className='section-details'>
                  <p>{t('download.details')}</p>
                </div>
                <div className='section-buttons'>
...
export default withNamespaces(['authenticator', 'common'])(Home)
