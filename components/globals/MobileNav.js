...
class MobileNav extends React.Component {
  ...
  clickOffMenu () { // User clicks on nav item, turn off menu
    this.setState({
      showMenu: false
    })
  }
  ...
  render () {
    ...
    return (
      <div>
          ...
          <div className='uk-container'>
            <div className='uk-grid-collapse ' data-uk-grid>
              ...
              <div className='menu-toggle uk-width-2-3'>
                <a id='menu-toggle' className='general-page' href='#' onClick={this.toggleMenu}>
                  <svg width='27' height='12' viewBox='0 0 27 12' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    <path d='M4.71295 3.80802L1.09993 1.00802C1.0246 0.949643 1.06588 0.828979 1.16118 0.828979H26.5165C26.5717 0.828979 26.6165 0.873751 26.6165 0.928979V3.72898C26.6165 3.78421 26.5717 3.82898 26.5165 3.82898H4.7742C4.75203 3.82898 4.73048 3.82161 4.71295 3.80802Z' fill='#F47E3E' />
                    <path d='M24.1033 8.69586L26.4771 11.4959C26.5322 11.5608 26.486 11.6605 26.4008 11.6605H9.80021C9.74498 11.6605 9.70021 11.6158 9.70021 11.5605V8.76052C9.70021 8.70529 9.74498 8.66052 9.80021 8.66052H24.027C24.0564 8.66052 24.0843 8.67344 24.1033 8.69586Z' fill='#F47E3E' />
                  </svg>
                </a>
              </div>
            </div>
        ...
        {this.state.showMenu ? (<MobileNavMenu clickOffMenu={this.clickOffMenu} t={t} />) : null}
